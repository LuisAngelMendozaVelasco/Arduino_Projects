 ...
 */
package com.luismendoza.project10_1;
 ...
 * @author luis-mendoza
 */
public class Project10_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Project 10.1 Soft Light");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Project10_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Project10_1().setVisible(true);
            }
        });
    }
