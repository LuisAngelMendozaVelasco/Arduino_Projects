 ...
 */
package com.luismendoza.project10_2;
 ...
 * @author luis-mendoza
 */
public class Project10_2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Project 10.2 Soft Colorful Light");
                ...
                serialPort1.addDataListener(new SerialPortDataListener() {
                    ...
                    public void serialEvent(SerialPortEvent event)
                    {
                        ...
                        if (newData.contains("on")) {
                            ...
                            try {
                                jButton3.setBackground(new Color(255 - Integer.parseInt(data[1]), 255 - Integer.parseInt(data[2]), 255 - Integer.parseInt(data[3])));
                            }
                            catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Project10_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Project10_2().setVisible(true);
            }
        });
    }
