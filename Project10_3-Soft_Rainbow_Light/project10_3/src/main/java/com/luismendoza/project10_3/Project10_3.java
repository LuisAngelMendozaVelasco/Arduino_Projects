 ...
 */
package com.luismendoza.project10_3;
 ...
 * @author luis-mendoza
 */
public class Project10_3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Project 10.3 Soft Rainbow Light");
                        ...
                        if (newData.contains("on")) {
                            ...
                            try {
                                for (int i = 0; i < leds.length; i++) {
                                    int[] colors = wheel(((i * 256 / 8) + Integer.parseInt(data[1])) & 255);
                                    leds[i].setBackground(new Color(colors[0], colors[1], colors[2]));
                                }
                            }
                            catch (Exception e) {
                                for (JButton led : leds) led.setBackground(Color.BLACK);
                            }
                        }
                        else for (JButton led : leds) led.setBackground(Color.BLACK);
                    }
                });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Project10_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Project10_3().setVisible(true);
            }
        });
    }
