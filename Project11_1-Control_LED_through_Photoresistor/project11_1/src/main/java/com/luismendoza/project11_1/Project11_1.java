 ...
 */
package com.luismendoza.project11_1;
 ...
 * @author luis-mendoza
 */
public class Project11_1 extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Project11_1.class.getName());

    /**
     * Creates new form Project11_1
     */
    public Project11_1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Project 11.1 Control LED through Photoresistor");
                ...
                serialPort1.addDataListener(new SerialPortDataListener() {
                    ...
                    public void serialEvent(SerialPortEvent event)
                    {
                        ...
                        if (newData.contains("on")) {
                            ...
                            try {
                                jButton3.setBackground(new Color(Integer.parseInt(data[1]), 0, 0));
                            }
                            catch (Exception e) { 
                                jButton3.setBackground(Color.BLACK);
                            }
                        }
                        else jButton3.setBackground(Color.BLACK);
                    }
                });
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Project11_1().setVisible(true));
    }
