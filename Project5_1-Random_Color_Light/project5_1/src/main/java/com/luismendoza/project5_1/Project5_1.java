 ...
 */
package com.luismendoza.project5_1;
 ...
 * @author luis-mendoza
 */
public class Project5_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Project 5.1 Random Color Light");
                ...
                serialPort1.addDataListener(new SerialPortDataListener() {
                    ...
                    public void serialEvent(SerialPortEvent event)
                    {
                        ...
                        if (newData.contains("on")) {
                            ...
                            try {
                                jButton3.setBackground(new Color(Integer.parseInt(RGB[1]), Integer.parseInt(RGB[2]), Integer.parseInt(RGB[3])));
                            }
                            catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Project5_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Project5_1().setVisible(true);
            }
        });
    }
