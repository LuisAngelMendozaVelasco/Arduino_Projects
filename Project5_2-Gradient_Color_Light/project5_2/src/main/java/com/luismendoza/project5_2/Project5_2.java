 ...
 */
package com.luismendoza.project5_2;
 ...
 * @author luis-mendoza
 */
public class Project5_2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Project 5.2 Gradient Color Light");
        ...
        jButton2.setText("Start RGB LED");
                ...
                serialPort1.addDataListener(new SerialPortDataListener() {
                    ...
                    public void serialEvent(SerialPortEvent event)
                    {
                        ...
                        if (newData.contains("on")) {
                            ...
                            try {
                                jButton3.setBackground(new Color((Integer.parseInt(RGB[1]) >> 16) & 0xFF, (Integer.parseInt(RGB[1]) >> 8) & 0xFF, (Integer.parseInt(RGB[1]) >> 0) & 0xFF));
                            }
                            catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Project5_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Project5_2().setVisible(true);
            }
        });
    }
