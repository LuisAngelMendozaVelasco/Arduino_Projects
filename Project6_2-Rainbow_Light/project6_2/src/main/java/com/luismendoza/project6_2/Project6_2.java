 ...
 */
package com.luismendoza.project6_2;
 ...
 * @author luis-mendoza
 */
public class Project6_2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Project 6.2 Rainbow Light");
                ...
                serialPort1.addDataListener(new SerialPortDataListener() {
                    ...
                    public void serialEvent(SerialPortEvent event)
                    {
                        ...
                        if (newData.contains("on")) {
                            ...
                            try {
                                leds[Integer.parseInt(RGB[1])].setBackground(new Color(Integer.parseInt(RGB[2]), Integer.parseInt(RGB[3]), Integer.parseInt(RGB[4])));
                            }
                            catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Project6_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Project6_2().setVisible(true);
            }
        });
    }
