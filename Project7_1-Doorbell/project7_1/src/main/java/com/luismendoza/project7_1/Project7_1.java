 ...
 */
package com.luismendoza.project7_1;
 ...
 * @author luis-mendoza
 */
public class Project7_1 extends javax.swing.JFrame {
    SerialPort serialPort1;
    SerialPort commPorts[];
    Boolean isPortOpen = false;

    /**
     * Creates new form Project7_1
     */
    public Project7_1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Project 7.1 Doorbell");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Project7_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Project7_1().setVisible(true);
            }
        });
    }
