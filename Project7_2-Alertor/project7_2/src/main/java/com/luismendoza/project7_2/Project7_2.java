 ...
 */
package com.luismendoza.project7_2;
 ...
 * @author luis-mendoza
 */
public class Project7_2 extends javax.swing.JFrame {
    SerialPort serialPort1;
    SerialPort commPorts[];
    Boolean isPortOpen = false;

    /**
     * Creates new form Project7_2
     */
    public Project7_2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Project 7.2 Alertor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Project7_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Project7_2().setVisible(true);
            }
        });
    }
