 ...
 */
package com.luismendoza.project9_1;
 ...
 * @author luis-mendoza
 */
public class Project9_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Project 9.1 Read the Voltage of Potentiometer");
        ...
        jProgressBar1.setString("ADC Value [0, 1023]");
                ...
                serialPort1.addDataListener(new SerialPortDataListener() {
                    ...
                    public void serialEvent(SerialPortEvent event)
                    {
                        ...
                        if (newData.contains("on")) {
                            ...
                            try {
                                jProgressBar1.setValue(Integer.parseInt(data[1]));
                            }
                            catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Project9_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Project9_1().setVisible(true);
            }
        });
    }
